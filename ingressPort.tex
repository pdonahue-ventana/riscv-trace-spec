...
\begin{itemize}
  ...
  \item Whether there has been an exception or interrupt, and if so the cause (from the \textbf{\textit{ucause/scause/vscause/mcause}} CSR)
...
\begin{table}[htp]
    ...
    \begin{tabulary}{\textwidth}{|l|l|p{80mm}|}
        ...
        \hline
        \textbf{dtype}[\textit{dtype\_width\_p}-1:0] & M & Data access type: \newline
        0: Load\newline
        1: Store\newline
        2: reserved\newline
        3: reserved\newline
